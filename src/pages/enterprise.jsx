...
const EnterprisePage = () => {
  const hero = {
    title: 'Pixiu Enterprise Distributions & Training',
    description:
      '<p>Pixiu was originally created by Isovalent and is a CNCF Graduation level project</p><p>The listed partners offer enterprise distributions, training, and commercial support for Pixiu</p>',
    illustration,
  };
