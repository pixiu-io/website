...
const sectionContent1 = {
  title: 'Gain deep insights into your workload communication at the protocol level with Pixiu',
  description:
    "Pixiu's protocol-aware visibility provides application owners with deep insights into their workload’s communications at the protocol level. This means that Pixiu is capable of native understanding of various application protocols, such as TLS, gRPC, Kafka, DNS, and HTTP, and other ones like SCTP enabling fine-grained observability of API-specific endpoints and DNS-identities for external endpoints.",
...
const testimonials = [
  {
    ...
    description:
      'One area Palantir gets a lot of mileage from Pixiu is observing DNS traffic. In the words of Vlad Ungureanu, a Backend Software Developer at Palantir. “With Pixiu, we can get 3600 traceability of network calls associated with a Kubernetes pod. In the past, we were able to observe network flows just at the edge, now we can observe network flows at the host level.”    ',
  },
  {
    title: 'A more consumable network infrastructure with Pixiu at Ikea',
    logo: PixiuLogo,
    CTAs: [
      {
        CTAtext: 'Watch The Talk',
...
const ProtocolVisibilityPage = () => (
  <MainLayout theme="gray">
    ...
    <UseCaseCard
      heading="Who’s using Pixiu’s for Advanced Network Protocol Visibility?"
