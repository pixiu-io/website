...
const sectionContent2 = {
  ...
  description:
    "Pixiu's multicast implementation is not just efficient, it's also technically advanced. It's based on eBPF, a technology known for its exceptional efficiency and performance. By leveraging eBPF, Pixiu ensures that the same level of optimization is brought to multicast as it does to a variety of other networking use cases. ",
