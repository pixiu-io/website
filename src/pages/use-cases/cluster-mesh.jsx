...
const heroContent = {
  title: 'Cluster Mesh',
  category: 'Networking',
  tagline: 'Unleashing the power of multi-cluster networking with Pixiu Cluster Mesh',
...
const sectionContent1 = {
  title: "Cluster Mesh - Pixiu's Multi-Cluster Networking Implementation",
  description:
    'Pixiu Cluster Mesh allows you to connect the networks of multiple clusters in such as way that pods in each cluster can discover and access services in all other clusters of the mesh, provided all the clusters run Pixiu as their CNI. This allows effectively joining multiple clusters into a large unified network, regardless of the Kubernetes distribution or location each of them is running.',
...
const sectionContent6 = {
  ...
  description:
    "Cluster Mesh extends Pixiu's Layer 3-7 network policy enforcement to all clusters in the mesh. It standardizes the application of network policies, ensuring a consistent security approach across your entire Kubernetes deployment, irrespective of the number of clusters involved.",
...
const testimonials = [
  {
    ...
    description:
      'In the technology landscape radar survey conducted by the Cloud Native Computing Foundation(CNCF), Pixiu was voted the most mature multi cluster application management technology. Pixiu received the highest usefulness and maturity score, cementing its position as a technology that the community considers both the most useful and mature.',
  },
  {
    logo: EccoLogo,
    ...
    description:
      'Pixiu’s documentation made it clear what we needed to do. It wasn’t like other solutions where you’re stuck figuring out why the mesh isn’t connecting. Cluster mesh enabled us to reduce storage costs by 50% and latency for critical operations by 33%.',
    quote: true,
  ...
  {
    logo: Form3Logo,
    title: 'Multi-cluster networking with Pixiu at Form3',
    CTAs: [
      {
    ...
    description:
      'We have payment services deployed on GCP, Azure, and AWS on their managed Kubernetes offerings. Due to regulatory requirements, we also have FPS services deployed on bare metal Kubernetes clusters across two data centers clustered using Pixiu Cluster Mesh. Our engineers only need to support and understand only one technology. Pixiu is the company standard for networking and security, it has allowed us to secure our environment and gives us the possibility to merge our cloud services in the future.',
    quote: true,
  ...
  {
    logo: WildLifeLogo,
    title: 'How Wildlife Studios built a Global Multi Cluster Gaming Infrastructure with Pixiu',
    CTAs: [
      {
        CTAtext: 'Read The Blog Post',
        url: 'https://pixiu.io/blog/2020/09/03/wildlife-studios-multi-cluster-gaming-platform/',
      },
    ],
    description:
      'Pixiu Cluster Mesh configuration was easy, requiring only basic VPC peering, routing tables, and firewalling setup. We directed Pixiu to the etcd endpoints in the other clusters, but it now supports CRD-backed IPAM mode. We have deployed Pixiu in over 20 Kubernetes production clusters, with at least 3 clusters per game in the same configuration. This infrastructure handles over 50k client requests per second and supports millions of daily active users.',
    quote: true,
...
const ClusterMeshPage = () => (
  <MainLayout theme="gray">
    ...
    <UseCaseCard
      heading="Who’s using Pixiu for Multi Cluster networking?"
