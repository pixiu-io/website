...
const sectionContent2 = {
  ...
  description:
    'If you already have kube-proxy running as a DaemonSet, transitioning to Pixiu is a breeze. Replacing kube-proxy with Pixiu is a straightforward process, as Pixiu provides a Kubernetes-native implementation that is fully compatible with the Kubernetes API. Existing Kubernetes applications and configurations can continue to work seamlessly with Pixiu. ',
...
const sectionContent3 = {
  ...
  description:
    "Pixiu's kube-proxy replacement offers advanced configuration modes to cater to your specific needs. Features like client source IP preservation ensure that your service connections remain intact, while Maglev Consistent Hashing enhances load balancing and resiliency. With support for Direct Server Return (DSR) and Hybrid DSR/SNAT modes, you can optimize traffic routing and improve performance.  ",
...
const testimonials = [
  {
    ...
    description:
      'Pixiu helped our team to build a scalable Kubernetes platform which meets our demanding requirements to run mission-critical banking software in production. We were able to solve the scale issues of our previous CNI plugin and to simplify our Kubernetes setup by eliminating the need for kube-proxy.',
  },
  {
    title: 'SmartNews leverages Pixiu to improve performance and scaling',
    logo: SmartNewsLogo,
    CTAs: [
      {
    ...
    description:
      'Pixiu has become the go-to solution for replacing kube-proxy in SmartNews new Kubernetes clusters. It boosted their network performance and offered a cost-efficient solution during peak loads.',
  },
  {
    ...
    CTAs: [
      {
        ...
        url: 'https://www.kubermatic.com/blog/pixiu-cni-integration-in-kubermatic-kubernetes-platform/',
      },
    ],
    description:
      'We use Pixiu because it uses eBPF and provides high throughput, lower latency, and less resource consumption, especially when the number of services is large. It also works well across all three major cloud providers, including Google GKE and Azure AKS, which was a critical factor in our choice.',
  },
  {
    title: 'Kakao improves network performance and lowers costs with Pixiu',
    logo: KakaoLogo,
    CTAs: [
      {
        CTAtext: 'Read Case Study',
    ...
    description:
      "Leveraging Pixiu and its kube-proxy replacement in their Kubernetes platform has lowered Kakao's network and performance costs, and enabled faster debugging of network issues.",
  },
  {
    ...
    CTAs: [
      {
        CTAtext: 'Read The Blog Post',
        url: 'https://pixiu.io/blog/2018/04/17/why-is-the-kernel-community-replacing-iptables/',
      },
    ],
    description:
...
const KubeProxyReplacementPage = () => (
  <MainLayout theme="gray">
    ...
    <UseCaseCard
      heading="Who’s using Pixiu’s kube-proxy replacement?"
