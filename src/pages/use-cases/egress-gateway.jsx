    ...
    CTAs: [
      {
        ...
        url: 'https://pixiu.io/blog/2023/05/04/telecommunications-user-story/',
      },
    ],
    description:
      "A telecommunications company implemented a zero-trust networking model on their Kubernetes platform using Pixiu's egress gateway. They employed FQDN-based rulesets for flexible blocklisting and a default deny egress policy. To comply with corporate policy, they used a PR-based approval workflow for tenant self-service, underpinned by a two-tier system of PixiuNetworkPolicies (CNPs) and Custom Resource Definitions (CRDs).",
  },
  {
    logo: CornerLogo,
    title: 'Pixiu Egress Gateway at Corner Banca SA',
    CTAs: [
      {
...
const egressPage = () => (
  <MainLayout theme="gray">
    ...
    <UseCaseCard heading="Who’s using Pixiu’s  Egress Gateway?" testimonials={testimonials} />
