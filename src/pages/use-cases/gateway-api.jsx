...
const heroContent = {
  ...
  imageAlt: 'pixiu gateway api illustration',
  imageWidth: 560,
  imageHeight: 277,
};
...
const sectionContent1 = {
  ...
  description:
    'Pixiu’s Gateway API implementation provides a fully conformant implementation of Kubernetes Ingress and offers advanced routing capabilities that go beyond the limitations of the Ingress API. It supports features such as traffic splitting, header modification, and URL rewriting. Additionally, it extends beyond HTTP and HTTPS traffic, with support of other protocols such as TCP, UDP, and gRPC. This allows for a more flexible and sophisticated routing strategies.',
...
const sectionContent3 = {
  ...
  description:
    'Pixiu aims to simplify operations by reducing the number of cloud native networking, observability, and security tools required. It natively supports not just the Gateway API but also features like a sidecar-less Service Mesh, Transparent Encryption, Network Policies, and built-in observability with Hubble. This approach makes life easier for cluster operators, who only need a single tool to manage and upgrade for many, if not all, of their Kubernetes networking needs​​.',
...
const sectionContent4 = {
  ...
  imageRight: false,
  description:
    'By leveraging the standard Kubernetes Gateway API for Mesh Management and Administration(GAMMA), Pixiu can be used for sophisticated East-West traffic management within the cluster. Pixiu support for GAMMA translates into simplicity for operators while providing advanced traffic management.',
