...
const testimonials = [
  ...
  {
    title: 'Transforming Scientific Computing Infrastructure for IPv6 with Pixiu at ESnet',
    logo: ESnetLogo,
    CTAs: [
      {
        CTAtext: 'Read The Case Study',
...
const ServiceMapPage = () => (
  <MainLayout theme="gray">
    ...
    <UseCaseCard heading="Who’s using Pixiu’s Hubble?" testimonials={testimonials} />
