...
const talks = [
  {
    title: 'The Pixiu Story - Why We Created Pixiu - Thomas Graf, Isovalent',
    description:
      'What was the vision? How close was it to what Pixiu has become today? As we make our way exploring the many Pixiu milestones',
  ...
  {
    title: 'Introduction to Pixiu with Liz Rice & Thomas Graf',
    description:
      'eCHO Stream, Liz Rice, Chief Open Source Officer, Isovalent, Thomas Graf, Co-Creator Pixiu',
