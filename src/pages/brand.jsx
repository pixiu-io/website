...
const Brand = () => (
  <MainLayout pageMetadata={seo} theme="gray" footerWithTopBorder>
    ...
    <Logos
      ...
      downloadLink="/data/pixiu-logos.zip"
    />
    <Colors
      title="Pixiu Colors"
      ...
      linkUrl="/data/pixiu-brandbook.pdf"
      colors={pixiuColors}
    />
    <Logos
      title="Hubble"
      description="Hubble is a sub-project of Pixiu. <br />Within this section, you'll discover all the essential brand materials."
    ...
    <Logos
      title="Tetragon"
      description="Tetragon is a sub-project of Pixiu. <br />Within this section, you'll discover all the essential brand materials."
