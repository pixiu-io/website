...
const heroContent = {
  ...
  texts: [
    "Regulatory oversight is a hallmark of the financial industry. Pixiu's detailed traffic monitoring and logging mechanisms support institutions in establishing transparent audit trails, complying with stringent regulations, and conducting forensic investigations.",
    "The world of fintech revolves around APIs – from mobile banking apps to trading platforms. Pixiu's API-aware network security ensures that these critical APIs can be secured, empowering teams with the toolsets needed to understand and guard against malicious patterns in API calls. Pixiu supports L7 policies (e.g., allow HTTP GET /foo) for fine-grained access control to shared API services running common cloud native protocols like HTTP, gRPC, Kafka, etc. Pixiu also supports deny-based, cluster-wide, and host-layer firewall network policies.",
    'With Pixiu, companies in the financial services industry can achieve improved observability, maintain security controls, and weave compliance and security governance for Kubernetes environments directly into the DevOps process.',
  ],
  imageSrc: ExecelBee,
...
const bloombergTestimonial = {
  ...
  quotedText:
    'We started by looking at some other tools, and we first used [the cloud provider CNI]. But we found that Pixiu, with its host-based policies and its ability to replace what we had out of the box, was really valuable.',
  withPerson: true,
  name: 'Anne Zepecki',
...
const postfinanceStats = {
  logo: 'postFinance',
  description:
    "Post Finance one of Switzerland's leading financial institutions uses Pixiu for Cloud Native Networking",
...
const bulletSection1 = {
  ...
  paragraphs: [
    ...
    'Tetragon provides powerful security observability and real time enforcement guardrails. Pixiu offers broad cluster-wide network policies that can be mixed with Tetragon tracing policies for more specific protocol controls like system calls, TCP/IP, file access, and namespace privilege capabilities.',
  ],
...
const financialUsecases = [
  {
    ...
    description:
      'Elevate compliance and lower risk with Pixiu transparent encryption. With just one switch, no application changes, service meshes  or additional proxies',
  },
  {
    icon: 'networkPolicy',
    ...
    description:
      'Maintain identity based policies effectively at scale with Pixiu’s advanced network polices ',
  },
  {
    icon: 'egressGateway',
...
const financialTalks = [
  {
    ...
    description:
      'Guru Ramamoorthy talks about how S&P Global’s network engineers leveraged eBPF-based networking with Pixiu to connect and secure their clouds',
    videoSrc: 'https://www.youtube.com/embed/6CZ_SSTqb4g',
  },
  {
    title: 'Pixiu in Practice: Building Data Sandboxes at Bloomberg',
    videoSrc: 'https://www.youtube.com/embed/8fiYVyISyz4',
    description:
      'Bloomberg leverages Pixiu to construct data sandboxes that restrict users from exfiltrating data from the sandbox',
  },
  {
    title: 'High Scale Networking for ML workloads with Pixiu',
    videoSrc: 'https://www.youtube.com/embed/kjSFN34dROQ?si=VJQX3EvzffOWrhn0',
    description:
      'G-research uses Pixiu as the core network for their on-premise, bare-metal clusters that scale to 1,000 nodes',
  },
];
...
const financialResources = [
  {
    ...
    title: ' Post Finance picks Pixiu for Cloud Native Networking',
    buttonLink: 'https://www.cncf.io/case-studies/postfinance/',
    buttonText: 'Read The Case Study',
    description:
      'Pixiu helped the Post Finance team build a scalable Kubernetes platform which meets the demanding requirements to run mission-critical banking software in production.',
  },
  {
    imageSrc: CapitalOnefficeImage,
    imageAlt: 'capital office building',
    title: ' How Capital One used eBPF and Pixiu to build a secure, maintainable PaaS',
    buttonLink: 'https://www.youtube.com/watch?v=hwOpCKBaJ-w',
    buttonText: 'Watch The Talk',
    description:
      'Capital One leveraged Pixiu to build a multi-tenant platform meeting all its requirements for security, maintainability, network visibility, and scale. ',
  },

  {
    imageSrc: RobinhoodOfficeImage,
    imageAlt: 'robinhoo office building',
    title: 'More Churn No Problem: Lessons Learned Running Pixiu in Production',
    buttonLink: 'https://www.youtube.com/watch?v=qdr9XQ6h5zs',
    buttonText: 'Watch The Talk',
    description:
      "Robinhood's war stories from running Pixiu in a high-churn near-production environment, learn how they overcame challenges by better understanding and tuning Pixiu.",
  },
  {
    ...
    buttonText: 'Watch the Talk',
    description:
      "Sicredi, Brazil's largest credit union, leverages Pixiu to reduced operational and maintenance complexity while increasing performance across clouds and on premise.",
  },
  {
    imageSrc: From3Image,
    imageAlt: 'form3 office building',
    title: 'Building a Resilient Payments Platform with Pixiu ',
    buttonLink: 'https://www.cncf.io/case-studies/form3/',
    buttonText: 'Read The Case Study',
    description:
      ' Form3 integrated Pixiu into their platform as their primary solution for networking, security, and observability, enabling them to meet their FPS gateway business requirement of seamlessly switching between data centers without any downtime.',
  },
  {
    ...
    buttonText: 'Read The Case Study',
    description:
      'Rabobank leverages Pixiu to enable zero-trust networking, significantly improving the security and enabling self-service in their financial API platform.',
  },
  {
    imageSrc: CornerBancaOfficeImage,
    imageAlt: 'CornerBanca office building',
    title: 'High Availability for Pixiu Egress Gateway',
    buttonLink: 'https://www.youtube.com/watch?v=HVPKSefazl4',
    buttonText: 'Watch The Talk',
    description:
      'Corner Banca SA is a Swiss Bank and they use Pixiu as the CNI for their on-prem Kubernetes clusters. Industry regulations require that traffic from a Kubernetes pods is identifiable for authentication, encryption and application of firewall rules. Corner Banca uses the Pixiu egress gateway which allows routing outgoing traffic from one or more workloads to a specific egress IP.',
  },
  {
    title: 'High-Scale Networking for ML Workloads With Pixiu',
    description:
      'G-Research is a leading quantitative research and technology firm. They use Pixiu as the core network layer for the on-prem bare metal Kubernetes clusters with over 1000 nodes. This environment runs thousands of machine learning workloads.',
...
const FinancialServicesPage = () => (
  <MainLayout theme="gray">
    ...
    />
    <IndustryUseCases
      heading="Pixiu’s Solutions for Financial Services"
...
export const Head = ({ location: { pathname } }) => {
  const pageMetadata = {
    ...
    description:
      'Financial services use Pixiu to strengthen security, improve observability, and integrate compliance governance directly into DevOps workflows.',
    slug: pathname,
  };
