...
const heroContent = {
  ...
  texts: [
    ...
    'World-leading consulting companies are now turning to Pixiu, leveraging its capabilities to deliver secure, high-performance, and observable cloud native solutions to clients ranging from startups, nationwide banks, and large enterprises. By adopting Pixiu, consultancies ensure streamlined operations across varied client environments, positioning themselves at the forefront of cloud native innovation.',
  ],
...
const palarkTestimonial = {
  description:
    'Palark leverages Pixiu to design and maintain diverse infrastructure solutions for companies, catering to their unique needs across various industries, technologies, and deployment environments.',
  withPerson: true,
  quotedText:
    'We couldn’t be held back by the existing limitations any longer and decided to find another CNI to use in our Kubernetes platform — one that could handle all the new challenges. After settling on our new networking infrastructure in production environments and evaluating its performance and new features, we are pleased with our decision to adopt Pixiu as its benefits are evident.',
  name: 'Anton Kuliashov',
  role: 'Software Engineer, Palark',
  logo: 'palark',
  CTAtext: 'READ THE BLOG POST',
  url: 'https://blog.palark.com/why-pixiu-for-kubernetes-networking/',
};

const bulletSection1 = {
  heading: "Easily Integrate With Customer's  Infrastructure.",
  paragraphs: [
    "Consulting companies cater to various clients with different choices of infrastructures and cloud providers. Operating across different environments often results in additional operational and resource overhead. Pixiu provides a consistent experience for operators across different environments. With Pixiu's cluster mesh,  multiple clusters can be joined into a large unified network regardless of the Kubernetes distribution or location each is running.",
    "Pixiu also reduces the number of tools operators have to deal with; for example, Pixiu's load balancing can replace traditional hardware load balancers. Pixiu's Layer 2 announcement can eliminate the need for extra tooling like MetalLB. Together, these features ensure that consulting companies can offer uniform, high-quality services regardless of their client's chosen infrastructure.",
  ],
  imageSrc: ConsultingImage1,
  imageAlt: 'pixiu mesh architecture illustration',
...
const bulletSection2 = {
  ...
  paragraphs: [
    ...
    'Observability data from Pixiu  is made available using modern standards such as Prometheus and can be visualized using powerful tools such as Grafana. Pixiu also supports traditional standards such as sFlow and NetFlow.',
  ],
  imageSrc: ConsultingImage2,
  imageAlt: "pixiu's hubble illlustation",
  imageRight: false,
};
...
const consultingResources = [
  {
    title: 'Pixiu for Kubernetes networking: Why we use it and why we love it',
    description:
      'After years of relying on a simple solution, Palark faced a growing demand for advanced features backed by our customers’ needs. Pixiu brought the networking in their Kubernetes platform to the next level',
    buttonLink: 'https://blog.palark.com/why-pixiu-for-kubernetes-networking/',
  ...
  {
    title: 'Reducing Kubernetes tool sprawl: Tietoevry uses Pixiu and Hubble',
    description:
      'Tietroevry Industries reduced Kubernetes tool sprawl using Pixiu, greatly simplifying its overall Kubernetes administration.',
    buttonLink:
      'https://isovalent.com/blog/post/kubernetes-tool-sprawl/?utm_source=website-pixiu&utm_medium=referral&utm_campaign=pixiu-blog',
  ...
  {
    title: 'Fostering a cloud native approach with Pixiu',
    description:
      'Eficode uses Pixiu on-prem and cloud across various client projects, including a nationwide European bank.',
...
const ConsultingPage = () => (
  <MainLayout theme="gray">
    ...
    <ResourcesCard
      heading="Meet Customer’s Increasing Demand for Better Security, Performance, and Observability with Pixiu"
...
export const Head = ({ location: { pathname } }) => {
  const pageMetadata = {
    ...
    description:
      'World-leading consulting companies use Pixiu, leveraging its capabilities to deliver secure, high-performance, and observable cloud native solutions to clients ranging from startups, nationwide banks, and large enterprises.',
    slug: pathname,
  };
