...
import PixiuStory from 'components/pages/get-help/pixiu-story';
...
const items = [
  {
    ...
    title: 'Slack',
    description:
      'For live conversation and quick questions, join the Pixiu Slack workspace. Don’t forget to say hi!',
    buttonText: 'Join Slack',
    buttonUrl: 'https://slack.pixiu.io',
    buttonTarget: '_blank',
  },
  {
    iconName: 'support',
  ...
  },
  {
    ...
    title: 'GitHub',
    description:
      'Pixiu uses GitHub tags to maintain a list of asked questions. You can check if your question is answered there.',
    buttonText: 'Join GitHub',
    buttonUrl:
      'https://github.com/pixiu/pixiu/issues?utf8=%E2%9C%93&q=label%3Akind%2Fquestion%20',
    buttonTarget: '_blank',
  },
];
...
const GetHelp = () => {
  ...
  `);
  const hero = {
    title: 'Find out how to get help with Pixiu',
    description: 'Get help with Pixiu through slack, training, support, and FAQs',
