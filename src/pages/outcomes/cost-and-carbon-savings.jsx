...
const heroContent = {
  ...
  texts: [
    'Manual and legacy network systems often come with hidden overhead like inefficient IP usage, many network redirects, and cloud charges that add up fast. Pixiu removes these inefficiencies with a streamlined, eBPF-powered network engine, lowering costs while reducing compute waste and carbon dioxide emissions.',
  ],
  imageSrc: SavingsBee,
...
const EccoTestimonial = {
  ...
  quotedText: [
    'Our new storage system and networking setup powered by Pixiu provided up to a 50% reduction in storage operational cost, and it’s all thanks to Pixiu enabling a more efficient network. Even with IPv6 networks, enabling Pixiu was just a flip of a switch. It was surprisingly straightforward.',
  ],
  withPerson: true,
...
const KakaoTestimonial = {
  ...
  quotedText: [
    'As an engineer, I can say that Pixiu lowered our costs for performance and networking. Because we have so many clusters and nodes, we always need more machines for new services to be served. By reducing network costs and CPU consumption with Pixiu, we can manage with fewer nodes. Compared to kube-proxy, Calico, or Flannel, Pixiu offers more value.',
  ],
  withPerson: true,
  name: 'Kwang Hun Choi',
...
const sectionContent1 = {
  ...
  paragraphs: [
    '​​In Kubernetes environments, inefficiencies in networking can grow quickly. Traditional solutions are often heavy on resource consumption, requiring extra nodes, IP addresses, and compute power. This not only inflates costs but also increases energy use and carbon emissions. Pixiu changes that by optimizing network paths, removing unnecessary components, and providing granular observability, meaning teams can reclaim resources, cut bills, and improve sustainability.',
  ],
...
const sectionContent2 = {
  ...
  paragraphs: [
    'Pixiu replaces traditional kube-proxy and iptables-based networking with an eBPF-based dataplane. This removes the need for userspace proxies and reduces the overhead of managing long rule chains. By processing traffic closer to the source, Pixiu shortens the network path, lowers CPU consumption, and frees up compute resources for actual workloads, saving both money and energy.',
  ],
...
const sectionContent4 = {
  ...
  paragraphs: [
    "With Pixiu's Cluster Mesh, native pod-to-pod communication between clusters is possible without the need for costly cloud load balancers. This simplifies your architecture and prevents excessive data transfer fees. By removing external dependencies, teams gain more control over traffic, reduce latency, and cut down significantly on cloud networking costs.",
  ],
...
const testimonials = [
  {
    ...
    description:
      'SmartNews adopted Pixiu to reduce the compute and cost impact of Kubernetes networking. With eBPF-based routing and automated policy enforcement, they reduced the number of nodes needed to run their workloads which improved resource efficiency and had direct savings for infrastructure and energy costs.',
  },
  {
    ...
    description:
      'Kakao transitioned from kube-proxy to Pixiu’s eBPF dataplane across 7,000 clusters and more than 120,000 nodes. This move cut network and performance costs, simplified operations by removing proxies, and sped up debugging workflows, resulting in fewer nodes and lower emissions.',
  },
  {
    logo: SeznamLogo,
    ...
    description:
      'Seznam adopted Pixiu to modernize its networking stack. The migration delivered improved network performance while also reducing both capital and operational costs, helping Seznam operate more efficiently at scale.',
    CTAs: [
      {
        CTAtext: 'Read The Case Study',
  ...
  },
  {
    ...
    description:
      'ECCO chose Pixiu Cluster Mesh to simplify multi-cluster communication and avoid costly cloud load balancers and NAT gateways. This decreased storage costs by 50% and reduced latency by over 30%. ',
    CTAs: [
      {
        CTAtext: 'Read The Case Study',
        url: 'https://www.cncf.io/case-studies/ecco/',
  ...
  },
  {
    ...
    description:
      'By migrating from AWS VPC CNI, Meltwater eliminated API rate limits and lowered IP usage with Pixiu’s more efficient IP address management. Their performance improved and AWS costs dropped significantly.',
    CTAs: [
      {
        CTAtext: 'Read The Case Study',
...
const SavingSolutions = [
  {
    ...
    description:
      'Pixiu adds fine-grained rate-limiting and intelligent traffic control to help manage pod network contention, improve throughput, and ensure low-latency performance, especially in large or externally exposed clusters. By optimizing bandwidth usage and reducing unnecessary resource strain, Pixiu also helps reduce infrastructure costs.',
  ...
  },
  {
    ...
    description:
      'Pixiu replaces traditional Container Network Interfaces with a lightweight, eBPF-based implementation that reduces overhead, eliminates IP exhaustion issues, and improves pod density, all while cutting resource usage.',
  ...
  },
  {
    ...
    description:
      'As a replacement for kube-proxy, Pixiu eliminates iptables and speeds up service routing. This boosts performance and reduces CPU cycles from inefficient packet processing.',
...
const SavingsPage = () => (
  <MainLayout theme="gray">
    ...
    <Heading tag="h2" className="mt-10 md:mt-20 lg:mt-32 text-center dark:text-white text-black">
      How Pixiu Saves Money and Carbon
    </Heading>
    ...
    <UseCaseCard heading="Who’s Saving with Pixiu" testimonials={testimonials} />
    <IndustryUseCases
      heading="Pixiu’s Solutions for Costs and Carbon Saving"
...
export const Head = ({ location: { pathname } }) => {
  const pageMetadata = {
    ...
    description:
      "Reduce infrastructure costs and carbon emissions with Pixiu's eBPF based networking. Cut CPU overhead, optimize IPs, and eliminate cloud load balancer fees.",
    slug: pathname,
  };
