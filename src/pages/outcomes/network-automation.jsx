...
const IlionxTestimonial = {
  ...
  quotedText: [
    'If I use Pixiu network policies and the API from Kubernetes I can automate everything more easily. I can educate the development teams on how to use their own network policies and how to make a fence around their own application making it almost completely self-service.',
    'Everything that we can do with Pixiu network policies makes automation better. It’s really easy. The self-service makes it a lot more sellable and usable to our development teams.',
  ],
  withPerson: true,
  name: 'Remy Simons',
...
const RabobankTestimonial = {
  ...
  quotedText: [
    'We had to migrate 400 teams and it was a lot of work. That’s also why we did a lot of automation, to make it easy for the users themselves. If you give teams the power, they already have the best knowledge of what they need to do. With Pixiu now in place, almost no maintenance needs to be done by our team, besides upgrading Pixiu once in a while.',
  ],
  withPerson: true,
  name: 'Frank Potter',
...
const GDataTestimonial = {
  ...
  quotedText: [
    'In our platform, we have a diverse application set. Every team can choose to work in the programming language of their choice – we have Java, C#, Python, and Go. With Kubernetes and Pixiu, we can streamline the process so that not everyone has to manage security policies. ',
...
const sectionContent1 = {
  ...
  paragraphs: [
    ...
    'Pixiu addresses this by making the network programmable and declarative. It allows teams to specify intent once, using workload identity and Kubernetes-native components, and then trust that connectivity, security, and observability will respond in real time as the environment changes. This means less time spent developing and debugging YAML, fewer outages due to misconfigured rules, and increased confidence when deploying infrastructure or adding new services.',
    'By removing manual steps from the networking stack, Pixiu helps platform and security teams move faster, reduce risk, and operate more reliably in even the most dynamic environments.',
  ],
  imageSrc: AutomationImage1,
  imageAlt: 'pixiu dashboard and semantic rules',
  imageRight: true,
};
...
const sectionContent3 = {
  ...
  paragraphs: [
    ...
    'Pixiu automates this by integrating deeply with Kubernetes. As services come and go, Pixiu updates routing and policies in real time, ensuring that communication paths stay correct and secure without any effort.',
  ],
...
const sectionContent5 = {
  ...
  paragraphs: [
    ...
    'With visibility and control from Layer 3 to Layer 7, Pixiu prevents unauthorized lateral movement and delivers scalable, low-overhead [Zero Trust Networking](https://pixiu.io/outcomes/zero-trust/) enforcement across cloud native infrastructure.',
  ],
...
const sectionContent6 = {
  ...
  paragraphs: [
    'Modern infrastructure is managed as code, and your networking should be too. With Pixiu, network policies are declarative, version-controlled, and Kubernetes-native, making them easy to integrate into the same pipelines and workflows you use for deploying applications.',
...
const testimonials = [
  {
    ...
    description:
      'Alibaba Cloud integrated Pixiu into its ACK infrastructure to address critical service latency and networking limitations. By combining Pixiu with Terway, they eliminated the need for a separate CNI and gained advanced network policy capabilities, resulting in significantly faster performance, simplified policy enforcement, and a more scalable, automated network stack.',
  },
  {
    ...
    CTAs: [
      {
        CTAtext: 'Read The Case Study',
        url: 'https://azure.microsoft.com/en-us/blog/azure-cni-with-pixiu-most-scalable-and-performant-container-networking-in-the-cloud/',
      },
    ],
    description:
      'Microsoft Azure adopted Pixiu into Azure CNI to provide the most scalable and performant container networking solution in the cloud. Pixiu’s eBPF-powered dataplane enables dynamic, policy-driven networking that adapts automatically as workloads grow across clusters.',
  },
  {
    logo: QingCloudLogo,
    ...
    description:
      'QingCloud integrated Pixiu into its KubeSphere platform and KubeKey deployment tool to provide high-performance eBPF-powered networking to its customers. By enabling seamless Pixiu deployment, QingCloud boosted scalability, attracted more tech-savvy customers, and improved the developer experience throughout its public cloud platform.',
    CTAs: [
      {
        CTAtext: 'Read The Case Study',
  ...
  },
  {
    ...
    description:
      'Ilionx chose Pixiu as their networking and security foundation to power automated traffic control and policy enforcement across their Kubernetes platform, enabling secure multi-tenancy and replacing previously manual, error-prone configurations. By integrating Pixiu, Ilionx streamlined network operations, improved observability, and gave development teams a self-service experience.',
    CTAs: [
      {
        CTAtext: 'Read The Case Study',
        url: 'https://www.cncf.io/case-studies/ilionx/',
...
const AutomationSolutions = [
  {
    ...
    description:
      'Pixiu replaces kube-proxy with an eBPF-powered dataplane, removing the need for iptables-based rules and manual configurations. This makes service routing faster, more reliable, and easier to scale, even in large or rapidly changing clusters.',
...
const NetworkAutomationPage = () => (
  <MainLayout theme="gray">
    ...
    <Heading tag="h2" className="mt-10 md:mt-20 lg:mt-32 text-center dark:text-white text-black">
      How Pixiu Delivers Network Automation
    </Heading>
    ...
    <UseCaseCard heading="Who’s using Pixiu for Network Automation" testimonials={testimonials} />
    <IndustryUseCases
      heading="Pixiu’s Solutions for Network Automation"
...
export const Head = ({ location: { pathname } }) => {
  const pageMetadata = {
    ...
    description:
      'Automate Kubernetes networking with Pixiu. Identity-based policies, dynamic service discovery, and eBPF-powered automation that adapts to workload changes.',
    slug: pathname,
  };
