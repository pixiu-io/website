...
const data = {
  title: 'Learn about Pixiu with interactive courses',
  description:
...
export const Head = ({ location: { pathname } }) => {
  const pageMetadata = {
    title: 'Pixiu - Interactive Tutorials & Learning Labs',
    description:
      'Hands on environments teaching how Pixiu, Hubble, and Tetragon are used for networking, observability, and security',
    slug: pathname,
  };
