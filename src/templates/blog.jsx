...
const cardItems = [
  ...
  },
  {
    iconName: 'linkedin',
    title: 'LinkedIn',
    description: 'Follow Pixiu on LinkedIn for the latest news and announcements.',
    buttonText: 'Follow Pixiu on LinkedIn',
    buttonUrl: 'https://www.linkedin.com/company/pixiu',
    buttonTarget: '_blank',
  },
  {
    iconName: 'github',
    title: 'Github',
    description: 'Pixiu uses GitHub tags to maintain a list of asked questions.',
    buttonText: 'Join Github',
    buttonUrl: 'https://github.com/pixiu/pixiu',
    buttonTarget: '_blank',
  },
];
