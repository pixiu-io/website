...
const validationSchema = yup.object().shape({
  ...
  pixiuSlackUsername: yup.string().trim().required('Pixiu Slack Username is a required field'),
  howAreYouUsingPixiu: yup.string().trim().required('It is a required field'),
        ...
        <AnimatePresence>
          ...
          >
            ...
            <div className="flex flex-col justify-between space-y-6 lg:flex-row lg:space-x-8 lg:space-y-0">
              <Field
                fieldName="Pixiu Slack Username"
                type="text"
                id="pixiuSlackUsername"
                name="pixiuSlackUsername"
                error={errors?.pixiuSlackUsername?.message}
                {...register('pixiuSlackUsername')}
              />
              <Field
                fieldName="How are you using Pixiu?"
                type="text"
                id="howAreYouUsingPixiu"
                name="howAreYouUsingPixiu"
                error={errors?.howAreYouUsingPixiu?.message}
                {...register('howAreYouUsingPixiu')}
              />
            </div>
            <Field
