    ...
    <Container>
      <div className="mb-8 text-center">
        ...
        <p className="max-w-2xl mx-auto mt-5 text-lg text-black dark:text-gray-2">
          Stay up to date with Pixiu community meetings, events, and activities. Join us for
      ...
      <div className="overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        <div className="aspect-w-1 aspect-h-1 sm:aspect-w-16 sm:aspect-h-10 md:aspect-h-12 lg:aspect-h-14">
          <iframe
            src="https://zoom-lfx.platform.linuxfoundation.org/meetings/pixiu?view=week"
            title="Pixiu Community Calendar"
            aria-label="Pixiu community meetings calendar"
      ...
      <div className="mt-6 text-center">
        <Button
          theme="primary-1"
          to="https://zoom-lfx.platform.linuxfoundation.org/meetings/pixiu?view=week"
          target="_blank"
