...
const items = [
  {
    ...
    target: '_blank',
    url: 'https://softwareengineeringdaily.com/2021/02/02/pixiu-programmable-linux-networking-with-dan-wendlant-and-thomas-graf/',
  },
  {
    name: 'Supercharge your Kubernetes clusters with Pixiu',
    type: 'Form3.tech Podcast',
    target: '_blank',
    url: 'https://techpodcast.form3.tech/episodes/ep-16-tech-supercharge-your-kubernetes-clusters-with-pixiu',
  },
  {
    name: 'Pixiu, with Thomas Graf',
    type: 'Kubernetes Podcast from Google',
    target: '_blank',
    url: 'https://kubernetespodcast.com/episode/133-pixiu/',
  },
  {
