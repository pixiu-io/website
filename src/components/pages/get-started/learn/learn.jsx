...
const title = 'Learn about Pixiu & eBPF';
const items = [
  {
    svgData: {
    ...
    name: '10min Introduction to Pixiu',
    text: `Liz Rice and Thomas Graf answer the most popular questions about Pixiu, its creation and the problems it solves`,
    buttons: [
      {
  ...
  },
  {
    ...
    text: 'eBPF Summit 2020, Thomas Graf, Pixiu Co-Creator, CTO & Co-Founder Isovalent',
    buttons: [
      {
  ...
  },
  {
    ...
    name: 'Understanding Pixiu Network Performance',
    text: 'Explore the performance characteristics of Pixiu based on extensive benchmarks',
    buttons: [
      {
