...
const enterprise = {
  ...
  description: 'Enterprise Distribution maintained by the creators of Pixiu.',
  linkUrl:
    'https://isovalent.com/products/kubernetes-networking/?utm_source=website-pixiu&utm_medium=referral&utm_campaign=pixiu-enterprise',
  linkTarget: '_blank',
  linkText: 'Learn more',
};
