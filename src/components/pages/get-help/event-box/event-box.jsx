...
const description =
  'All you need for a successful Pixiu talk. Are you passionate about Pixiu and want to share your experience with the broader community? We want to help you tell your story! Whether writing a blog post, creating a YouTube or Twitch video, or speaking at a conference, we will help you deliver your Pixiu story to a broad audience.';
const buttonText = 'Request Event Help';
const buttonUrl = '/telling-story';
const links = [
  // {
  //   text: 'Pixiu intro slides',
  //   url: '/',
  //   description: 'As start Pixiu & eBPF Introduction CNCF Bratislava',
  // },
  {
