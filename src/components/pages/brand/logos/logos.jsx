...
import { pixiuLogos, hubbleLogos, tetragonLogos } from './data/logos';
...
const Logos = ({ title, description, downloadLink, brand = 'pixiu', titleSize = 'md' }) => (
...
Logos.propTypes = {
  ...
  brand: PropTypes.oneOf(['pixiu', 'hubble', 'tetragon']).isRequired,
};
