...
const title = 'Pixiu brand';
const description =
  'Pixiu serves as our primary project. Logo is a crucial part of our brand and one of our most valuable assets. We must ensure its proper usage.';
