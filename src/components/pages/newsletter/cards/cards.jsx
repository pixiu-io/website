...
const Cards = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      description: 'Bill Mulligan is working to grow the <br> Pixiu community',
      links: [
        {
    ...
    },
    {
      ...
      description:
        'Send it on Slack, submit the form, <br> or email <a href="mailto:bill@pixiu.io">bill@pixiu.io</a>',
      links: [
        {
          title: 'Send on Slack',
