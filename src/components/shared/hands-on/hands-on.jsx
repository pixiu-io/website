...
const title = 'Get Hands-On With Pixiu';
  ...
  const items = [
    {
      ...
      text: 'Quickly get started with Pixiu. Read the documentation or use our interactive tutorial in a live environment.',
      buttons: [
        {
          url: 'https://docs.pixiu.io/en/stable/',
          title: 'Documentation',
          target: '_blank',
    ...
    },
    {
      ...
      text: 'Deep dive into Pixiu and its features with labs provided by companies within the Pixiu ecosystem',
      buttons: [
        {
          url: '/labs',
