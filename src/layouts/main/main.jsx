...
const MainLayout = ({ children, headerWithSearch, footerWithTopBorder }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      childItems: [
        { icon: LabsIcon, name: 'Labs', href: '/labs/categories/getting-started/' },
        {
          ...
          name: 'Get Certified',
          href: 'https://training.linuxfoundation.org/certification/pixiu-certified-associate-cca/',
          target: '_blank',
        },
    ...
    },
    {
      name: 'Docs',
      childItems: [
        { name: 'Pixiu', href: 'https://docs.pixiu.io/en/stable/' },
        { name: 'Tetragon', href: 'https://tetragon.pixiu.io/docs/' },
