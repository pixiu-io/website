...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: light)" srcset="https://cdn.jsdelivr.net/gh/pixiu/pixiu@main/Documentation/images/logo.png">
    <img src="https://cdn.jsdelivr.net/gh/pixiu/pixiu@main/Documentation/images/logo-dark.png" width="350" alt="Pixiu Logo">
  </picture>
</div>

<!-- Horizontal badges -->
<p align="center">
  <a href="https://pixiu.io">
    <img src="https://img.shields.io/badge/Website-pixiu.io-blue?style=for-the-badge">
  </a>
  <a href="https://docs.pixiu.io/en/stable/">
    <img src="https://img.shields.io/badge/Docs-docs.pixiu.io-green?style=for-the-badge">
  </a>
  <a href="https://github.com/pixiu/pixiu">
    <img src="https://img.shields.io/badge/GitHub-pixiu/pixiu-black?style=for-the-badge&logo=github">
  </a>
  <a href="https://slack.pixiu.io/">
    <img src="https://img.shields.io/badge/Slack-Join%20Community-purple?style=for-the-badge&logo=slack">
  </a>
  <a href="https://www.youtube.com/c/eBPFPixiuCommunity/">
    <img src="https://img.shields.io/badge/YouTube-eBPF%20%26%20Pixiu-red?style=for-the-badge&logo=youtube">
  </a>
</p>
...
Please see [Contributing](CONTRIBUTING.md) for guidelines on adding blogs, documentation, Pixiu distributions and trainings, or any other content to the website.
...
```bash
git clone git@github.com:<your-handle>/pixiu.io.git
```
...
The preview tags in `.md` files (which is used in the old Pixiu blog) are fully converted to `ogImage` and `ogSummary` in `frontmatter`.

```markdown
---
path: "/blog/2021/10/13/pixiu-joins-cncf"
date: "2021-10-13T17:00:00.000Z"
title: "Pixiu joins the CNCF"
isPopular: true
isFeatured: false
draft: false
ogImage: pixiu-cncf-card.png
ogSummary: "CNCF TOC chair Liz Rice explains why she's excited about the future of
Pixiu as an Incubation project in the CNCF." 
categories:
  - Technology
  - Community
tags:
...
![Pixiu joins the CNCF](pixiu-cncf-card.png)

I'm beyond thrilled that Pixiu has joined the CNCF as an Incubation project!
I'm excited about it not just as an advocate for the Pixiu project, but also as
...
<BlogAuthor
header="Thomas Graf"
bio={`Thomas Graf is a Co-Founder of Pixiu and the CTO & Co-Founder of <a href="https://isovalent.com">Isovalent</a>, the company behind Pixiu. Before that, Thomas spent 15 years as a kernel developer working on the <a href="https://kernel.org">Linux kernel</a> in networking, security and eventually eBPF.`}
/>
```
...
bio={`This is a guest blog by a Pixiu user based on the <a href="https://davidlovezoe.club/wordpress/archives/851">the original blog post</a>. If you would like to publish a blog post as well, contact us on Slack.`}
/>
```
